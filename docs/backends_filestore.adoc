...
And we need to find the needed paths
...
For testing it is nice to have an in memory implementation.
...
And a function to get back the raw store. This allows us to check if the
correct files were manipulated.
